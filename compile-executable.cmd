...
g++ -DSHELLCODE_LEN=%shellcode_len_hex% -DRESOURCE_NAME="L\"%targetfile_noext%\"" "%script_dir%executable.cpp" resource.res -o "%script_dir%executable.exe" -static-libgcc -static-libstdc++
